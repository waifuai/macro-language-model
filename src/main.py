...
def run_gemini_mode(waifu_name: str, debug: bool, response_templates: Dict[tuple[str, str], List[str]], max_turns: int = 10) -> None:
    ...
    waifu = WaifuChatbot(waifu_name, debug=debug, response_templates=response_templates)
...
def run_auto_mode(waifu_name: str, debug: bool, response_templates: Dict[tuple[str, str], List[str]], max_turns: int = 10) -> None:
...
def main() -> None:
    ...
    if args.interactive:
        waifu = WaifuChatbot(args.waifu_name, debug=args.debug, response_templates=response_templates)
        register_keywords(waifu)
        register_transforms(waifu)
        ...
        # Use the new auto mode with Gemini
        run_auto_mode(args.waifu_name, args.debug, response_templates, args.auto)

    elif args.gemini:
        # Pass the WaifuChatbot instance to run_gemini_mode
        run_gemini_mode(args.waifu_name, args.debug, response_templates)
